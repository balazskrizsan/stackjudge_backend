...
public class AddressRecord extends TableRecordImpl<AddressRecord> implements Record9<Long, Long, String, Double, Double, Double, Double, LocalDateTime, Long> {

    private static final long serialVersionUID = -1986558532;
