...
import com.kbalazsworks.stackjudge.api.oauth2.CustomOAuth2UserService;
import com.kbalazsworks.stackjudge.api.oauth2.CustomOidcUserService;
import com.kbalazsworks.stackjudge.api.oauth2.OAuth2AccessTokenResponseConverterWithDefaults;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter
{
    ...
    protected void configure(HttpSecurity http) throws Exception
    {
        ...
        http.authorizeRequests().and().formLogin()//
            ...
            .passwordParameter("j_password").and().oauth2Login().loginPage("/login").failureHandler(
            authenticationFailureHandler).defaultSuccessUrl("/home").userInfoEndpoint()
            .oidcUserService(customOidcUserService).userService(customOAuth2UserService).and().tokenEndpoint()
            .accessTokenResponseClient(authorizationCodeTokenResponseClient());
        // Logout Config
        http.authorizeRequests().and().logout().deleteCookies("JSESSIONID").logoutUrl("/logout").logoutSuccessHandler(
