...
public class AddressRecord extends UpdatableRecordImpl<AddressRecord> implements Record9<Long, Long, String, Double, Double, Double, Double, LocalDateTime, String> {

    private static final long serialVersionUID = 1569134956;
    ...
    @Override
    public Row9<Long, Long, String, Double, Double, Double, Double, LocalDateTime, String> valuesRow() {
    ...
    @Override
    public AddressRecord values(Long value1, Long value2, String value3, Double value4, Double value5, Double value6, Double value7, LocalDateTime value8, String value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public AddressRecord(Long id, Long companyId, String fullAddress, Double markerLat, Double markerLng, Double manualMarkerLat, Double manualMarkerLng, LocalDateTime createdAt, String createdBy) {
        super(Address.ADDRESS);
