...
public class NotificationRecord extends UpdatableRecordImpl<NotificationRecord> implements Record6<Long, String, Short, JSONB, LocalDateTime, LocalDateTime> {

    private static final long serialVersionUID = -92027151;
    ...
    /**
     * Setter for <code>public.notification.user_ids_user_id</code>.
     */
    ...
    /**
     * Getter for <code>public.notification.user_ids_user_id</code>.
     */
    ...
    @Override
    public Row6<Long, String, Short, JSONB, LocalDateTime, LocalDateTime> valuesRow() {
    ...
    public Field<String> field2() {
        return Notification.NOTIFICATION.USER_IDS_USER_ID;
    }
    ...
    @Override
    public NotificationRecord values(Long value1, String value2, Short value3, JSONB value4, LocalDateTime value5, LocalDateTime value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public NotificationRecord(Long id, String userIdsUserId, Short type, JSONB data, LocalDateTime createdAt, LocalDateTime viewedAt) {
        super(Notification.NOTIFICATION);
