...
public class CompanyOwnerRecord extends UpdatableRecordImpl<CompanyOwnerRecord> implements Record3<Long, Long, LocalDateTime> {

    private static final long serialVersionUID = -1263183449;
    ...
    /**
     * Setter for <code>public.company_owner.user_id</code>.
     */
    ...
    /**
     * Getter for <code>public.company_owner.user_id</code>.
     */
    ...
    public Field<Long> field2() {
        return CompanyOwner.COMPANY_OWNER.USER_ID;
    }
    ...
    @Override
    public CompanyOwnerRecord value2(Long value) {
        setUserId(value);
        return this;
    }
    ...
    @Override
    public CompanyOwnerRecord values(Long value1, Long value2, LocalDateTime value3) {
        value1(value1);
        value2(value2);
        value3(value3);
        return this;
     ...
     */
    public CompanyOwnerRecord(Long companyId, Long userId, LocalDateTime createdAt) {
        super(CompanyOwner.COMPANY_OWNER);
